...
/**
 * @fileOverview Master Agreement Repository for My Auction Portal.
 * UK-EN: Legally binding templates for MMOA and Unconditional sales.
 */

export const MMOA_SALES_AGREEMENT_TEMPLATE = {
  id: "mmoa-sales-agreement-v1",
