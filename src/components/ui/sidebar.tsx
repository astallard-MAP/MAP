      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-white p-0 text-sidebar-foreground [&>button]:hidden shadow-2xl border-none"
            style={
              {
            ...
            side={side}
          >
            <div className="flex h-full w-full flex-col bg-white overflow-hidden shadow-inner">{children}</div>
          </SheetContent>
        </Sheet>
      )
    }
